...
using static Day21_2.Program;

// too much junk code from a misguided attempt, but too much work
// for no gain to make it pretty again.
//
// hint: if you have to press 3 arrows, and 2 of them are the same,
// you need to group them, so <^< should be <<^ or ^>^ should be ^^>
// or else your cost goes up moving back and forth between the same
// buttons even if your paths between them are optimal. Ugh.
